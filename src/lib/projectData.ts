...
export const projectData = [
  ...
  {
    title: "Blog App",
    image: "Screenshot_from_2025-06-29_07-36-39_pqhxx1",
    videoUrl: "",
    liveUrl: "https://next-js-blog-app-mocha.vercel.app/",
    description:
      "A full-stack blog application built with Next.js and TypeScript, featuring a robust admin dashboard for content moderation and user management. The platform includes role-based permissions, a ticketing system for user support, and real-time notifications, all powered by a PostgreSQL database with Prisma.",
    techStack: [
      "Next.js",
      "Zustand",
      "Shadcn ui",
